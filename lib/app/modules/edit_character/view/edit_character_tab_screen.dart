...
class EditCharacterTabScreen extends StatelessWidget {
  final CharacterModel character;

  const EditCharacterTabScreen({super.key, required this.character});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: TextWidget.headlineLarge(AppStrings.editCharacter, color: AppColors.textPrimaryColor(isDark)),
        backgroundColor: AppColors.background(isDark),
        centerTitle: false,
        elevation: 0,
